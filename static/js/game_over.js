document.addEventListener('DOMContentLoaded', function () {
    ...
    const useCrystalButton = document.getElementById('use-crystal');
    ...
    useCrystalButton.addEventListener('click', function () {
        // タイムクリスタルを使用する処理をここに追加
        console.log('タイムクリスタルを使用しました');
    });
});